...
def choosecharacter():
    global health, modhealth, shield, longdmg, closedmg, magicdmg, charactertype
    while True:
        try:
            print("Please type in the name of the character you'd like to play with. (Example: Medic)")
            charactertype = input('---->')
            if charactertype == "Barbarian" or charactertype == "Medic" or charactertype == "Archer":
                break

        except:
            print("Error in 'choosecharacter()'")
        ...
        if charactertype == "Barbarian":
            ...
            print(f"You've chosen the character '{str(charactertype)}'")
            print("\n---------------------------------------------------")
            print(f"Health: {str(health)}/{str(health + modhealth)}")
            print(f"Shield: {str(shield)}/{str(shield + modshield)}")
            print(f"Long-range damage: {str(longdmg)}/{str(longdmg + modlongdmg)}")
            print(f"Close-range damage: {str(closedmg)}/{str(closedmg + modclosedmg)}")
            print(f"Magic damage: {str(magicdmg)}/{str(magicdmg + modmagicdmg)}")
